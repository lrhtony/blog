...
查壳发现有个奇怪的玩意![image-20240502004402803](https://img.0a0.moe/blog/2024/05/02/2024iscc/53654a819b1e81cdb18e33b0a6a89e1604438ada53c75f54a87a623096fa3f2c.webp)

但是进入IDA后发现并不影响，输入传进check后判断![image-20240502021003303](https://img.0a0.moe/blog/2024/05/02/2024iscc/188ac78fb2b68dc309dcb36462c76baad08754c58eced8b38685dfdfbb088912.webp)

然后进行处理后再通过`check_2`进行判断![image-20240502021050783](https://img.0a0.moe/blog/2024/05/02/2024iscc/c121fef0768110fd7bcd74e4ec2b984b4247affb0d0bdf0d32bf8dd747a98309.webp)
...
![image-20240502022248977](https://img.0a0.moe/blog/2024/05/02/2024iscc/f9b3ee063226fd9e24d45c9b984c2be8f9e47a94f9d61e17ed3125b68d1dfb3e.webp)

使用`upx.exe -d Cryptic.exe`脱壳后打开，得到主要逻辑![image-20240502022555856](https://img.0a0.moe/blog/2024/05/02/2024iscc/50ca13b38cfb41faef8fa506c2a51ffafc026436de47ac778682de535d94ad59.webp)

可以发现输入会先进入`mix`，再进入`Encryption`。但观察mix函数内部即可发现，其内部操作在输入长度为26时前后完全抵消。通过动态调试也可以验证![image-20240502023245005](https://img.0a0.moe/blog/2024/05/02/2024iscc/4ab1485589957d954b04dba30a21e9adf878e0cc93795742527f71cad723c6bf.webp)
...
![image-20240502025022566](https://img.0a0.moe/blog/2024/05/02/2024iscc/774b0ceadf73c616ba011c62e4f6cb2f866fd688ce15913d6129187a8cf098fa.webp)紧接着就有一个函数，通过`srand`设置种子生成24个随机数与处理过的flag异或，在这里可以通过动调直接dump出来![image-20240502025055843](https://img.0a0.moe/blog/2024/05/02/2024iscc/0c8fc0f0b6531c2b2a3525bbad83d0b55f50c357494f0a925dc315fe02b3c124.webp)

![image-20240502024618292](https://img.0a0.moe/blog/2024/05/02/2024iscc/32cb241292ec0dce79ada93e382775d2b881c23ad251eff3a4f8d1e2fc51193a.webp)

然后再往下看我们可以发现有个Tea加密（此处函数已重命名）

![image-20240502024759081](https://img.0a0.moe/blog/2024/05/02/2024iscc/35ddeeb9631b43eabaead1fe485a91dcb37df3e114ee92b51305a39abd9dcefc.webp)
...
![image-20240502203900531](https://img.0a0.moe/blog/2024/05/02/2024iscc/8564bcad2b36d3785c07de9a63f096ef871614e5d3e18c02b30c71980f017b89.webp)
...
再看后半部分。这里可以通过IDA逆向库文件或动态调试获取`str2`得到，我选择动调。首先给apk开启调试权限<img src="https://img.0a0.moe/blog/2024/05/02/2024iscc/9dea386e117240394ff74bf586c72f5b751134630471f52e0a7d8a80d0da3972.webp" alt="image-20240502033210433" style="zoom: 33%;" />

然后在Jadx对应函数位置下个断点![image-20240502033406137](https://img.0a0.moe/blog/2024/05/02/2024iscc/897600cba7ce1d2043d75a042055cc116c2f38c533a469893a53cf2c1899d2fc.webp)

手机安装应用后在Jadx中启动并附加，运行到断点处，逐步运行直到得到参数

![image-20240502033928182](https://img.0a0.moe/blog/2024/05/02/2024iscc/acf5a06094604a56297797b7fc943b747f15bc4226b41f1e59da3f0f70af3c78.webp)
...
![image-20240502034536192](https://img.0a0.moe/blog/2024/05/02/2024iscc/d1013f45453cc11bef903151ca3f5bc9dd66a779a0f248dc751827d07a3edbf6.webp)
...
![image-20240502041747893](https://img.0a0.moe/blog/2024/05/02/2024iscc/24ce58feaf5722e0ef534dc5e2bbf02ef2523083e6d91f6ad1a1fbc1eba1649c.webp)

阅读`getflag`的反编译代码

![image-20240502041830629](https://img.0a0.moe/blog/2024/05/02/2024iscc/79a962f5ace2b9489617e192000d03a89ff01d05d349e520aef43443b964bb1a.webp)
